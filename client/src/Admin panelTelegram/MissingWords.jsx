...
export default function MissingWords() {
    ...
    const fetchMissingWords = async () => {
        try {
            const response = await axios.get(`${SERVER_URL}/api/getMissingWords`);
    ...
    const handleSaveClick = async (id) => {
        try {
            const response = await axios.put(`${SERVER_URL}/api/updateMissingWord`, {
                id,
                ...editedData
            });
    ...
    const handleDeleteClick = async (id) => {
        try {
            const response = await axios.delete(`${SERVER_URL}/api/deleteMissingWord`, {
                data: { id }
            });
            if (response.data.success) {
    ...
    const handleAddClick = async () => {
        try {
            const response = await axios.post(`${SERVER_URL}/api/addMissingWord`, editedData);
    ...
    return (
        <>
            <div className="font-san mt-5 bg-white/5 rounded-2xl py-10 px-5 md:p-5">
                <p className="text-[#38B6FF] flex items-center gap-2 font-bold">Missing Word Vault</p>
                                        ...
                                        <td className="flex flex-col items-center gap-2 mt-5">
                                            {editingIndex === index ? (
                                                ...
                                                <>
                                                    ...
                                                    <button
                                                        className="bg-white font-semibold rounded-md w-full px-3 py-1 text-blue-500"
